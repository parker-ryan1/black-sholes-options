# Black-Scholes Options Pricing - Production Makefile
# ====================================================
...
# Targets
MAIN_TARGET = $(BIN_DIR)/black_scholes
...
package: release test
	...
	@mkdir -p dist/black_scholes_options
	@cp $(MAIN_TARGET) dist/black_scholes_options/
	@cp $(STREAMLIT_APP) dist/black_scholes_options/
	@cp requirements.txt dist/black_scholes_options/
	@cp README.md dist/black_scholes_options/
	@cp config.json dist/black_scholes_options/
	@tar -czf dist/black_scholes_options.tar.gz -C dist black_scholes_options
	@echo "Package created: dist/black_scholes_options.tar.gz"

# Docker build
.PHONY: docker
docker:
	@echo "Building Docker image..."
	@docker build -t black-scholes-options .
	@echo "Docker image built: black-scholes-options"
...
.PHONY: help
help:
	@echo "Black-Scholes Options Pricing - Build System"
	@echo "============================================="
	@echo ""
	...
	@echo "  streamlit        - Run Streamlit web application"
	...
	@echo "  make streamlit   - Start web interface"
